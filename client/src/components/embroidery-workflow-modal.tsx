...
import { Scissors, Upload, MousePointerClick, Copy, CheckSquare, FileUp, Loader2, Square, Circle, Minus as MinusIcon, Triangle, Shield, Star, Hexagon, Pentagon, Heart, Octagon, ChevronRight, ArrowRight, Shapes } from "lucide-react";
                            ...
                            <div className="w-full h-full flex items-center justify-center text-gray-600">
                              {(() => {
                                switch (element.elementType) {
                                  ...
                                  case 'oval': return <Circle className="w-7 h-7" />;
                                  case 'heart': return <Heart className="w-7 h-7" />;
                                  case 'octagon': return <Octagon className="w-7 h-7" />;
                                  case 'arch': return <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 22V10a8 8 0 0 1 16 0v12" /></svg>;
                                  case 'malteseCross': return <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2l4 5-3 2h0l5 3-5 4-2-3v0l-3 5-4-5 3-2h0l-5-3 5-4 2 3v0z" /></svg>;
                                  case 'chevron': return <ChevronRight className="w-7 h-7" />;
                                  case 'arrow': return <ArrowRight className="w-7 h-7" />;
                                  case 'ribbon': return <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 8l2-4h12l2 4v8l-2 4H6l-2-4V8z" /></svg>;
                                  default: return <Shapes className="w-7 h-7" />;
                                }
                              })()}
                            </div>
                          ) : (
