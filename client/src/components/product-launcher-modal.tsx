...
const productCategories = [
  {
    ...
    description: "Full Colour, Single Colour, Zero, and Reflective screen printed heat applied transfers",
  ...
  },
  {
    ...
    description: "DTF, UV DTF, Sublimation, Badges, and specialty transfers",
    icon: dtfIconPath,
