...
import { AlertTriangle, Camera, Users, FileCheck } from "lucide-react";
        ...
        <div className="space-y-6">
          <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
            <p className="text-sm text-orange-800 dark:text-orange-200 mb-3">
              <strong>Production Flow:</strong> This file contains raster/image content. For best print quality, vector files (SVG/PDF) are recommended.
            </p>
              ...
              <div className="border rounded-lg p-4 hover:border-primary/50 transition-colors">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-lg mb-2">Use PDF As-Is</h3>
                    <p className="text-muted-foreground text-sm mb-4">
                      This PDF already contains my finished artwork or pre-generated garment pages.
                      Import it directly without any changes.
                    </p>
                    <Button 
                      onClick={() => handleOptionSelect('use-as-is')}
                      variant="outline"
                      className="w-full"
                    >
                      Use My PDF As-Is
