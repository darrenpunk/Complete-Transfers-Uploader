...
## Recent Fixes (Oct 2025 - Dec 2025)
- **Dec 2025: CMYK Slider Fix**: Fixed issue where dragging CMYK color sliders in the garment color modal would trigger the upload modal. Added `noDragEventsBubbling: true` to react-dropzone configuration to prevent drag events from bubbling up.
