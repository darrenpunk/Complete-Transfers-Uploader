...
✓ **Template grouping with DTF support**: Added "Full Colour Transfer Sizes", "Single Colour Transfer Sizes", "DTF Transfer Sizes", "Woven Badges", and "Applique Badges" groups with custom icons
