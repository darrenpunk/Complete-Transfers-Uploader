...
/**
 * Adobe Illustrator compatible CMYK to RGB conversion
 * Reverses the Adobe CMYK conversion process
 */
export function adobeCmykToRgb(c: number, m: number, y: number, k: number): { r: number; g: number; b: number } {
  ...
  // Adobe-style CMYK to RGB conversion
...
// Also create the convertRGBToAdobeCMYK alias for compatibility
export function convertRGBToAdobeCMYK(rgb: { r: number; g: number; b: number }) {
