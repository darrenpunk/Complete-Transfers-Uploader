            ...
            if (hasCMYK) {
              ...
              try {
                ...
                try {
                  ...
                  console.log(`🎯 INKSCAPE PDF→SVG WITH COLOR MANAGEMENT - PRESERVING NEUTRAL GREYS`);
                  svgCommand = `inkscape --pdf-poppler "${pdfPath}" --export-type=svg --export-filename="${svgPath}" --export-text-to-path --export-ignore-filters --export-ps-level=3`;
                } catch {
