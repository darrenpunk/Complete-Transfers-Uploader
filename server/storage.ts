...
export class MemStorage implements IStorage {
  ...
  private initializeTemplateSizes() {
    const standardSizes = [
      ...
      { id: "reflective-A3", name: "reflective_A3", label: "A3 Reflective Single Colour", width: 297, height: 420, pixelWidth: 842, pixelHeight: 1191, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night" },
      { id: "reflective-A4", name: "reflective_A4", label: "A4 Reflective Single Colour", width: 210, height: 297, pixelWidth: 595, pixelHeight: 842, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night" },
      { id: "reflective-A5", name: "reflective_A5", label: "A5 Reflective Single Colour", width: 148, height: 210, pixelWidth: 420, pixelHeight: 595, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night" },
      { id: "reflective-A6", name: "reflective_A6", label: "A6 Reflective Single Colour", width: 105, height: 148, pixelWidth: 298, pixelHeight: 420, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night" },
      { id: "reflective-transfer-size", name: "reflective_transfer_size", label: "295×100mm Reflective Single Colour", width: 295, height: 100, pixelWidth: 836, pixelHeight: 283, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night" },
      { id: "reflective-square", name: "reflective_square", label: "95×95mm Reflective Single Colour", width: 95, height: 95, pixelWidth: 269, pixelHeight: 269, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night" },
      { id: "reflective-badge", name: "reflective_badge", label: "100×70mm Reflective Single Colour", width: 100, height: 70, pixelWidth: 283, pixelHeight: 198, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night" },
      { id: "reflective-small", name: "reflective_small", label: "60×60mm Reflective Single Colour", width: 60, height: 60, pixelWidth: 170, pixelHeight: 170, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night" },
