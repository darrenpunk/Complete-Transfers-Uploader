...
export class MemStorage implements IStorage {
  ...
  private initializeTemplateSizes() {
    const standardSizes = [
      ...
      { id: "template-transfer-size", name: "transfer_size", label: "295×100mm", width: 295, height: 100, pixelWidth: 836, pixelHeight: 283, group: "Screen Printed Transfers", description: "Full-Colour screen printed heat applied transfers", placeholderImage: null },
      { id: "template-square", name: "square", label: "95×95mm", width: 95, height: 95, pixelWidth: 269, pixelHeight: 269, group: "Screen Printed Transfers", description: "Full-Colour screen printed heat applied transfers", placeholderImage: null },
      { id: "template-badge", name: "badge", label: "100×70mm", width: 100, height: 70, pixelWidth: 283, pixelHeight: 198, group: "Screen Printed Transfers", description: "Full-Colour screen printed heat applied transfers", placeholderImage: null },
      { id: "template-small", name: "small", label: "60×60mm", width: 60, height: 60, pixelWidth: 170, pixelHeight: 170, group: "Screen Printed Transfers", description: "Full-Colour screen printed heat applied transfers", placeholderImage: null },
      ...
      { id: "metallic-transfer-size", name: "metallic_transfer_size", label: "295×100mm Metallic", width: 295, height: 100, pixelWidth: 836, pixelHeight: 283, group: "Screen Printed Transfers", description: "Full-Colour screen printed with metallic finish", placeholderImage: null },
      ...
      { id: "single-transfer-size", name: "single_transfer_size", label: "295×100mm Single Colour", width: 295, height: 100, pixelWidth: 836, pixelHeight: 283, group: "Screen Printed Transfers", description: "Screen printed using our off-the-shelf colour range", placeholderImage: null },
      ...
      { id: "zero-transfer-size", name: "zero_transfer_size", label: "295×100mm Zero", width: 295, height: 100, pixelWidth: 836, pixelHeight: 283, group: "Screen Printed Transfers", description: "Zero inks are super stretchy and do not bleed!", placeholderImage: null },
      { id: "zero-square", name: "zero_square", label: "95×95mm Zero", width: 95, height: 95, pixelWidth: 269, pixelHeight: 269, group: "Screen Printed Transfers", description: "Zero inks are super stretchy and do not bleed!", placeholderImage: null },
      { id: "zero-badge", name: "zero_badge", label: "100×70mm Zero", width: 100, height: 70, pixelWidth: 283, pixelHeight: 198, group: "Screen Printed Transfers", description: "Zero inks are super stretchy and do not bleed!", placeholderImage: null },
      { id: "zero-small", name: "zero_small", label: "60×60mm Zero", width: 60, height: 60, pixelWidth: 170, pixelHeight: 170, group: "Screen Printed Transfers", description: "Zero inks are super stretchy and do not bleed!", placeholderImage: null },
      ...
      { id: "woven-square", name: "woven_square", label: "95×95mm Woven", width: 95, height: 95, pixelWidth: 269, pixelHeight: 269, group: "Digital Transfers", description: "Polyester textile woven badges", placeholderImage: null },
      { id: "woven-badge", name: "woven_badge", label: "100×70mm Woven", width: 100, height: 70, pixelWidth: 283, pixelHeight: 198, group: "Digital Transfers", description: "Polyester textile woven badges", placeholderImage: null },
      ...
      { id: "reflective-transfer-size", name: "reflective_transfer_size", label: "295×100mm", width: 295, height: 100, pixelWidth: 836, pixelHeight: 283, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night", placeholderImage: null },
      { id: "reflective-square", name: "reflective_square", label: "95×95mm", width: 95, height: 95, pixelWidth: 269, pixelHeight: 269, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night", placeholderImage: null },
      { id: "reflective-badge", name: "reflective_badge", label: "100×70mm", width: 100, height: 70, pixelWidth: 283, pixelHeight: 198, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night", placeholderImage: null },
      { id: "reflective-small", name: "reflective_small", label: "60×60mm", width: 60, height: 60, pixelWidth: 170, pixelHeight: 170, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night", placeholderImage: null },
      ...
      { id: "sublimation-A6", name: "sublimation_A6", label: "A6 Sublimation", width: 148, height: 105, pixelWidth: 420, pixelHeight: 298, group: "Digital Transfers", description: "Sublimation heat transfers are designed for full-colour decoration of white, 100% polyester", placeholderImage: null },
      { id: "sublimation-transfer-size", name: "sublimation_transfer_size", label: "295×100mm Sublimation", width: 295, height: 100, pixelWidth: 836, pixelHeight: 283, group: "Digital Transfers", description: "Sublimation heat transfers are designed for full-colour decoration of white, 100% polyester", placeholderImage: null },
