...
export class MemStorage implements IStorage {
  ...
  private initializeTemplateSizes() {
    const standardSizes = [
      ...
      { id: "template-A6", name: "A6", label: "A6", width: 148, height: 105, pixelWidth: 420, pixelHeight: 298, group: "Screen Printed Transfers", description: "Full-Colour screen printed heat applied transfers" },
      ...
      { id: "metallic-A6", name: "metallic_A6", label: "A6 Metallic", width: 148, height: 105, pixelWidth: 420, pixelHeight: 298, group: "Screen Printed Transfers", description: "Full-Colour screen printed with metallic finish" },
      ...
      { id: "single-A6", name: "single_A6", label: "A6 Single Colour", width: 148, height: 105, pixelWidth: 420, pixelHeight: 298, group: "Screen Printed Transfers", description: "Screen printed using our off-the-shelf colour range" },
      ...
      { id: "zero-A6", name: "zero_A6", label: "A6 Zero", width: 148, height: 105, pixelWidth: 420, pixelHeight: 298, group: "Screen Printed Transfers", description: "Zero inks are super stretchy and do not bleed!" },
      ...
      { id: "woven-A6", name: "woven_A6", label: "A6 Woven", width: 148, height: 105, pixelWidth: 420, pixelHeight: 298, group: "Digital Transfers", description: "Polyester textile woven badges" },
      ...
      { id: "applique-A6", name: "applique_A6", label: "A6 Applique", width: 148, height: 105, pixelWidth: 420, pixelHeight: 298, group: "Digital Transfers", description: "Fabric applique badges" },
      ...
      { id: "reflective-A6", name: "reflective_A6", label: "A6", width: 148, height: 105, pixelWidth: 420, pixelHeight: 298, group: "Screen Printed Transfers", description: "Our silver reflective helps enhance the visibility of the wearer at night" },
      ...
      { id: "sublimation-A6", name: "sublimation_A6", label: "A6 Sublimation", width: 148, height: 105, pixelWidth: 420, pixelHeight: 298, group: "Digital Transfers", description: "Sublimation heat transfers are designed for full-colour decoration of white, 100% polyester" },
