...
export function checkFileComplexityEarly(
  ...
  const EARLY_PATH_THRESHOLD = 15000;
  const EARLY_ELEMENT_THRESHOLD = 15000;
...
function analyzeVectorComplexity(svgContent: string): {
  ...
  // Threshold: >15000 paths OR >15000 total elements
  const PATH_THRESHOLD = 15000;
  const ELEMENT_THRESHOLD = 15000;
